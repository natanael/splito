...
var ChangeHandler = /** @class */ (function () {
    ...
    ChangeHandler.prototype.handle = function (path, stats) {
        var _this = this;
        if (this.thatWasUs) {
            console.log(chalk_1.default.grey("last change was ours, ignoring.."));
            this.thatWasUs = false;
            return;
        }
        if (stats.size == 0) {
            console.log(chalk_1.default.grey("got an empty file, false change, fs hiccup, ignoring.."));
            return;
        }
