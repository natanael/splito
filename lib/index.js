...
export function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var watcher, mainChangeHandler;
        return __generator(this, function (_a) {
            fs.writeFileSync(GHOSTFILE, DEFAULT_CONTENT);
            watcher = new ChecksumEmitter(GHOSTFILE);
            ...
            mainChangeHandler = new ChangeHandler();
            // let mem = process.memoryUsage()
            watcher.on("checksumChanged", function () {
                // console.log(memChange(mem, process.memoryUsage()))
                // mem = process.memoryUsage()
                mainChangeHandler.handle(GHOSTFILE);
            });
            console.info(chalk.blue("All set! edit ./".concat(GHOSTFILE)));
            return [2 /*return*/];
        });
    });
}
